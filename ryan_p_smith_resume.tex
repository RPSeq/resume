...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    \textbf{{\Large Ryan P Smith}} & \textbf{San Francisco, CA} \\
...
\section{Experience}
    \resumeSubHeadingListStart
	    ...
	    \resumeItemListStart
	    	...
	    	\resumeItem{Software Engineering, Data}
