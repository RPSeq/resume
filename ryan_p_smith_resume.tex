...
\section{About Me}
   ...
   {DevOps, continuous integration, Kubernetes, distributed computing, AWS, GCP, containers, automation, object-oriented and functional programming, data enginering, bioinformatics}
...
\section{Experience}
    \resumeSubHeadingListStart
	    ...
	    {Data Engineering Contractor}{January 2019 -- Present}
